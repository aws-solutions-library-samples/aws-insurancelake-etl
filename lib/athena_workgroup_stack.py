...
class AthenaWorkgroupStack(cdk.Stack):
    def __init__(
            self, 
            scope: Construct, 
            construct_id: str, 
        ...
        glue_scripts_temp_bucket
            The S3 bucket object for Glue scripts temporary storage
        kwargs: optional
        ...
        buckets = ImportedBuckets(self, logical_id_suffix='AthenaWorkgroupStack')
